...
\section{Limits}
    ...
    \begin{definition}
        ...
        \begin{equation*}
            \nabla f : \bar{x} \in A \mapsto  \left( \frac{\partial f}{\partial x_1},..., \frac{\partial f}{\partial x_n} \right)  \in \mathbb{R}^n
        \end{equation*}
    \end{definition}
    ...
    \end{definition}
    \begin{definition}
        We define the gradient as $\nabla f : (x,y) \in A \mapsto \left( \frac{\partial f}{\partial x},\frac{\partial f}{\partial y} \right) \in \mathbb{R}^2$
    \end{definition}
    \begin{definition}
    ...
    \subsection*{Study of the maxima and minima}
        ...
        \end{theorem}
        \begin{theorem}
            Let $f : A \subseteq \mathbb{R}^2 \rightarrow \mathbb{R}$ and let $(x_0,y_0)$ an extreme relative in A
        \end{theorem}
\end{document}